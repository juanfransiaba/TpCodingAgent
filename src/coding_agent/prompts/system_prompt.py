...
- Act directly with the tools you have. Do NOT produce step-by-step plans, and do NOT ask the user for permission before acting.
- In your final answer, report only what was actually done (based on real tool evidence and the subagent brief). Do not describe hypothetical future steps or propose a plan.
